...
insert into public.digital_products (id, name, description, price_inr, file_url, preview_image, category, is_active) values
  ('a1b2c3d4-e5f6-7a8b-9c0d-1e2f3a4b5c6d', ' 2026 Bracket Tracker (Excel)', 'Interactive automated Excel workbook to track matches, group stages, and calculate knockout possibilities automatically as scores are updated.', 5, 'https://supabase.co/storage/v1/object/public/products/bracket_tracker_2026.xlsx', 'https://images.unsplash.com/photo-1508098682722-e99c43a406b2?w=500&auto=format&fit=crop&q=60', 'Templates', true),
  ('b2c3d4e5-f6a7-8b9c-0d1e-2f3a4b5c6d7e', 'World Cup Wallpaper Pack (10 images)', 'Ultra-HD mobile and desktop football themed wallpapers showcasing World Cup stadiums, superstars, and neon team art.', 3, 'https://supabase.co/storage/v1/object/public/products/wallpaper_pack_2026.zip', 'https://images.unsplash.com/photo-1518063319789-7217e6706b04?w=500&auto=format&fit=crop&q=60', 'Wallpapers', true),
  ('c3d4e5f6-a7b8-9c0d-1e2f-3a4b5c6d7e8f', 'All 48 Teams Stats Sheet', 'Deep statistical data analysis sheet for all 48 participating countries: qualifying goals, key tactical formations, expected goals, and history.', 4, 'https://supabase.co/storage/v1/object/public/products/team_stats_2026.pdf', 'https://images.unsplash.com/photo-1431324155629-1a6edd1d141d?w=500&auto=format&fit=crop&q=60', 'Tools', true),
  ('d4e5f6a7-b8c9-0d1e-2f3a-4b5c6d7e8f9a', 'Prediction Strategy Guide (PDF)', 'Comprehensive statistics-based handbook outlining predictions optimization: historic host advantage, historical draws, and expected scores.', 6, 'https://supabase.co/storage/v1/object/public/products/prediction_strategy_2026.pdf', 'https://images.unsplash.com/photo-1540747737956-37872404af60?w=500&auto=format&fit=crop&q=60', 'Tools', true),
  ('e5f6a7b8-c9d0-1e2f-3a4b-5c6d7e8f9a0b', 'Complete Fan Bundle', 'Get the Ultimate Fan compilation including the Excel Bracket Tracker, 10x Wallpapers, 48 Teams stats sheet, and Prediction Strategy Guide at a discounted rate.', 15, 'https://supabase.co/storage/v1/object/public/products/complete_fan_bundle_2026.zip', 'https://images.unsplash.com/photo-1510563800743-aed2364902b9?w=500&auto=format&fit=crop&q=60', 'Bundles', true)
on conflict (id) do nothing;
